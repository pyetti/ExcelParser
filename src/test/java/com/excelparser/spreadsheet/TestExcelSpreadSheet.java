...
public class TestExcelSpreadSheet {
    ...
    public static void setupTests() {
        ...
        spreadSheet.put("A1", "Jan1");
        spreadSheet.put("B1", "Feb1");
        spreadSheet.put("C1", "Mar1");
        spreadSheet.put("A2", "Jan2");
        spreadSheet.put("B2", "Feb2");
        spreadSheet.put("C2", "Mar2");
        spreadSheet.put("A3", "Jan3");
        spreadSheet.put("B3", "Feb3");
        spreadSheet.put("C3", "Mar3");
        spreadSheet.put("A4", "Jan4");
        spreadSheet.put("C4", "Mar4");
    ...
    public void testRemoveColumn() {
        ...
        spreadSheet.put("B1", "Feb1");
        spreadSheet.put("C1", "Mar1");
        spreadSheet.put("D1", "Mar1");
        spreadSheet.put("A2", "Jan2");
        spreadSheet.put("B2", "Feb2");
        spreadSheet.put("C2", "Mar2");
        spreadSheet.put("D2", "Mar1");
        spreadSheet.put("A3", "Jan3");
        spreadSheet.put("B3", "Feb3");
        spreadSheet.put("C3", "Mar3");
        spreadSheet.put("D3", "Mar1");
        spreadSheet.put("A4", "Jan4");
        spreadSheet.put("C4", "Mar4");
        spreadSheet.put("A5", "Jan5");
        spreadSheet.put("C6", "Mar6");
        spreadSheet.put("D4", "Mar1");
        spreadSheet.put("A7", "Jan7");
